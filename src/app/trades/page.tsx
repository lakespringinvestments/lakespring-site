...
export const metadata = {
  title: "Trade Records — Lakespring Investments",
  ...
  return (
    <div className="bg-teal-800 -mt-px">
      <div className="max-w-3xl mx-auto px-6 py-24 md:py-32 text-center">
        ...
        <h1 className="font-serif text-4xl md:text-5xl lg:text-6xl text-white tracking-tight leading-[1.05] mb-7">
        ...
        <div className="max-w-md mx-auto bg-teal-700/40 rounded-2xl p-8 text-left border border-teal-600">
          <p className="font-serif text-2xl text-white mb-3 tracking-tight">
            Get notified at launch
          </p>
          <p className="text-cream-100 text-sm mb-6">
            Join the journal — the first to know when Trade Records opens.
          </p>
          <EmailSignup />
        </div>
      </div>
