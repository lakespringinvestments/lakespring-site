      ...
      {hasImage ? (
        <>
          ...
          <div className="absolute inset-0 flex flex-col justify-end p-7 md:p-9">
            {article.byline && (
              <span className="inline-block bg-black/50 text-white text-[9px] uppercase tracking-[0.2em] font-semibold px-2 py-1 rounded mb-3">
                {article.byline}
              </span>
            )}
      ...
      {hasImage ? (
        <>
          ...
          <div className="absolute inset-0 flex flex-col justify-end p-6 md:p-7">
            {article.byline && (
              <span className="inline-block bg-black/50 text-white text-[9px] uppercase tracking-[0.2em] font-semibold px-2 py-1 rounded mb-2">
                {article.byline}
              </span>
            )}
